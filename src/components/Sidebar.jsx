...
function Sidebar({set_displayToken,set_displayPair,displayToken,displayPair,set_searchType}) {
    ...
    const Token_page =(e)=>{
        ...
        set_searchType('Token')
    }

    const Pair_page =(e)=>{

        set_displayToken(false)
        ...
        <div className='sidebar_container'>
            <div className='sidebar_content_1'>
                ...
                <div className='sidebar_box'>
                        ...
                        <span className='box_1_name'>NFTify</span>
                </div>
                <div className='sidebar_box' id='sidebar_token_div' onClick={e=>Token_page(e)} style={{background:displayToken?'#F30050':''}}>
