...
function Pair_Address({pairData}) {
    ...
    return (
        <>
            <div className='pair_container'>
                <div className='result_heading'>Pair Search Results</div>
                <div className='pair_data'>

                {pairData.status?

pairData.data.slice(0,10).map((item)=>{
    return(
...
<div className='pair_card'>
    ...
    <div className='pair_card_box'>
            <div>
                <div className='card_text'>Pair created at</div>
                <div className='card_text'>Symbol</div>
                <div className='card_text'>Dex ID</div>
                <div className='card_text'>Pair Address</div>
            </div>
            <div className='pair_datas'>
                <div className='card_text'>{item.pairCreatedAt}</div>
                <div className='card_text'>{item.baseToken.symbol}</div>
                <div className='card_text'>{item.dexId}</div>
                <div className='card_text'>{item.pairAddress}</div>
            </div>
            <div>
...
<div className='pair_card'>
    ...
    <div className='pair_card_box'>
            ...
            <div className='pair_datas'>
                <div className='card_text'>{item.baseToken.name}</div>
                <div className='card_text'>{item.baseToken.symbol}</div>
                <div className='card_text'>{item.baseToken.address}</div>
            </div>
            <div>
                <div className='symbol_div'>
                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div className='pair_card'>
    ...
    <div className='pair_card_box'>
            ...
            <div className='pair_datas'>
                <div className='card_text'>{item.quoteToken.name}</div>
                <div className='card_text'>{item.quoteToken.symbol}</div>
                <div className='card_text'>{item.quoteToken.address}</div>
            </div>
            <div>
                <div className='symbol_div'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div className='pair_card'>
    ...
    <div className='pair_card_box'>
            <div>
                <div className='card_text'>Price Native</div>
                <div className='card_text'>Price USD</div>
            </div>
            <div className='pair_datas'>
                <div className='card_text'>{item.priceNative}</div>
                <div className='card_text'>{item.priceUsd}</div>
            </div>
            <div>
                <div className='symbol_div'>
                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
:<div className='no_status'>{pairData.message}</div>}
