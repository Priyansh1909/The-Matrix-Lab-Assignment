...
function Token_Address({tokenData}) {
    return (
        <>
            <div className='token_container'>
                <div className='result_heading'>Token Search Results</div>
                <div className='token_data'>

                    {tokenData.status?

                    tokenData.data.slice(0,10).map((item)=>{
                        return(
                    ...
                    :<div className='no_status'>{tokenData.message}</div>}
